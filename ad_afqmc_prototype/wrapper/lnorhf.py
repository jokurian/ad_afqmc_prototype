...
from .. import lnodriver, config
from ..prep import integrals
from ..core.system import System
from ..ham.chol import HamChol
from ..meas.rhf import overlap_r,build_meas_ctx,force_bias_kernel_r,lnoenergy_kernel_r,energy_kernel_r
from ..prop.afqmc import make_prop_ops
from ..prop.blocks import lno_block
...
class LnoRhf:
    ...
    def setup(self, prjlo, mo_coeff, h0, h1, chol):
        ...
        self.meas_ops = MeasOps(
            ...
            kernels={
                k_force_bias: force_bias_kernel_r,
                k_energy: energy_kernel_r,
                k_lnoenergy: lnoenergy_kernel_r,
            },
        )


        self.prop_ops = make_prop_ops(self.ham_data.basis, self.sys.walker_kind)
